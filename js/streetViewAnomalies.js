...
//When the user clicks on a marker, an infowindow appears that details the type of anomaly and the exact location (Lat/Lng). 
        ...
        var message = '<div id = "content" style = "width: 250px; height:300px;"></div>';
        //markName.toString() + '<div>' + "<b>Location:</b>" + " " + markPos.toString();
		...
		function addInfoWindow(marker, message) {
			...
			new google.maps.event.addListener(marker, 'click', function(event) {
				...
				google.maps.event.addListener(infoWindow, 'domready', function() {
					...
					pano = new google.maps.StreetViewPanorama(document.getElementId("content"), {

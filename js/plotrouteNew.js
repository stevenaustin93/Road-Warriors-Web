...
function createInfo(routes, startEndObj) {
	...
	var message = '<h5><b>Route: </b><i>' + $('#start').val() + "</i> to <i>" + $('#end').val();
	for (var i = 0; i < routes.length; i++) {
		var currString = '<div style=\"float: left; position:relative\"></i><br><b>Safety Rating: </b><i>' + routes[i].safety + '/10</i>' +
		'</i><br><b>Estimated Time: </b><i>' + routes[i].time.toPrecision(4) + ' min</i>' +
